...
2. `docs/completion-record.md` に記載する完了事項は、単独で完了を主張せず、必ず `docs/tasks/*.md`、`docs/acceptance/*.md`、`CHANGELOG.md`、`docs/releases/*.md` のいずれかへリンクすること。
...
2. `workflow-cookbook` は Birdseye/Codemap、Task Seed、Acceptance、reusable CI、security/release evidence、cross-repo workflow plugin、自己改善ループ blueprint の実行手順と契約を扱うこと。
