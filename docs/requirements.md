...
- `workflow-cookbook`は自己改善DTO、集計規則、nudge、review lifecycleの正本である。
- `self-improvement/v1`としてGateCatalogEntry、GateObservation、EvidenceConsumptionObservation、ImprovementObservationBundle、GateEffectivenessReportを公開する。
- 既定閾値はunused 30日/20 Task/0評価、no-effect 20評価/効果0、override 5件かつ70%以上、unread Evidence 10生成かつ明示ack率10%以下とする。
